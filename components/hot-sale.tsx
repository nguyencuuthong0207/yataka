          ...
          {products.map((product) => (
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-grow">
                ...
                {/* Bottom cluster: price + progress + button */}
                <div className="mt-auto">
                  {/* Price */}
                  <div className="mb-2">
                    <div className="whitespace-nowrap">
                      <span className="block text-lg font-bold text-amber-600">{product.price}</span>
                      <span className="block text-sm text-gray-400 line-through">{product.originalPrice}</span>
                    </div>
                  </div>

                  <div className="mb-2 bg-gray-100 rounded p-2 text-xs">
                  ...
                  <button className="w-full bg-amber-500 hover:bg-amber-600 text-white py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition">
